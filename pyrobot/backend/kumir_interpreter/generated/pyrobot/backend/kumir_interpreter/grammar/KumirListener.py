...
class KumirListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by KumirParser#usesClause.
    def enterUsesClause(self, ctx:KumirParser.UsesClauseContext):
        pass

    # Exit a parse tree produced by KumirParser#usesClause.
    def exitUsesClause(self, ctx:KumirParser.UsesClauseContext):
        pass


    # Enter a parse tree produced by KumirParser#useStatement.
    def enterUseStatement(self, ctx:KumirParser.UseStatementContext):
        pass

    # Exit a parse tree produced by KumirParser#useStatement.
    def exitUseStatement(self, ctx:KumirParser.UseStatementContext):
        pass
    ...
    # Enter a parse tree produced by KumirParser#introBlock.
    def enterIntroBlock(self, ctx:KumirParser.IntroBlockContext):
        pass

    # Exit a parse tree produced by KumirParser#introBlock.
    def exitIntroBlock(self, ctx:KumirParser.IntroBlockContext):
        pass
