...
// Updated based on provided DocBook XML documentation.
// NOTE: Ensure this file and source code are saved and processed using UTF-8 encoding.
...
CHAR_TYPE           : ('сим' | 'СИМ');
STRING_TYPE         : ('лит' | 'ЛИТ');
TABLE_SUFFIX        : 'таб' | 'ТАБ'; // Kept for potential use if arrayType rule is removed
