...
✅ Реализовано копирование значений обратно для параметров 'рез'/'аргрез'  
✅ Тесты tmp/test_proc.kum и tmp/test_proc_res.kum проходят успешно
✅ Процедуры с параметрами готовы к использованию
